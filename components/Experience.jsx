...
const Experience = () => {
    return (
        <div className='justify-center'>
            {/* Heading */}
            <div className='mt-[231px] w-full h-[200px] mx-auto opacity-500 '>
                <div className='pt-[33px] w-[300px] md:w-[500px] lg:w-[841px] h-134px mx-auto text-3xl md:text-4xl lg:text-[64px] leading-10 md:leading-[57px] lg:leading-[77px] text-center'>
            ...
            <div className='w-[250px] md:w-[393px] h-[46px] mt-[124px] mx-auto rounded-[60px] border-solid border-[1px] border-[#E24F29] gap-[10px] px-[24px] py-[13px] justify-center hover:bg-[#E24F29] group cursor-pointer'>
