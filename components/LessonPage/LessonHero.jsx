    ...
    return (
        <div className='flex relative'>
            <div className='relative h-[704px] grid grid-rows-2 lg:grid-cols-2 items-center justify-between  md:mx-auto lg:ml-[98px]'>
                ...
                {/* Left side */}
                <div className='lg:w-[50%] container bg-[#FBFBFB] mt-[240px]'>
                    <div className='flex flex-col'>
                        ...
                        <div class="md:ml-5 px-2">
                            <button class="z-[1000] lg:w-[295px] h-12 bg-[#E24F29] hover:bg-white px-3 text-white hover:text-[#E24F29] rounded-[60px] py-3 font-nunito text-[12px] md:text-[18px] border-solid border-[1px] border-[#E24F29]">
                                Get started now
                            </button>
                        </div>
                    </div>
            ...
            {/* play button */}
            <div className='absolute z-20 ml-[170px] md:ml-[380px] lg:ml-[700px] mt-[800px] md:mt-[875px] lg:mt-[375px]'>
                <Link href='https://youtu.be/HnKIfZoiKmc' className=''>
                    <Image
                        src={Videobutton}
                        className='w-[30px] md:w-[50px] lg:w-[80px] '
                    />
                </Link>
            </div>
