...
const ProductLibraryNav = () => {
    const [productLibraryNav, setProductLibraryNav] = useState(false)


    const handleNav = () => {
        setProductLibraryNav(!productLibraryNav);
    }
    ...
    return (
        <div className=' w-full h-[113px] text-white'>
            ...
            <div className={productLibraryNav ? ' h-full mx-auto flex items-center justify-between' : ' w-full h-full items-center justify-between flex'}>
                ...
                <div className={productLibraryNav ? 'absolute text-black  flex lg:hidden z-10 right-0 top-[0px] h-screen bg-[#FBFBFB]' :
                    'absolute hidden'}>
                ...
                {/* Desktop Menu */}
                <div className={productLibraryNav ? 'hidden ' : 'hidden lg:flex items-center justify-between  w-full'} >
                    {/* left side */}
...
export default ProductLibraryNav